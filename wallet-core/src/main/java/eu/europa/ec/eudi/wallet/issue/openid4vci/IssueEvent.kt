...
sealed interface IssueEvent {
     ...
     * @see[DocumentId] for the document id
     */
    data class DocumentIssued(val documentId: DocumentId, val name: String, val docType: String, val credential: String) : IssueEvent {
        internal constructor(issuanceRequest: IssuanceRequest, documentId: DocumentId, credential: String) : this(
            documentId,
            issuanceRequest.name,
            issuanceRequest.docType,
            credential
